...
// Complete the exercise in the space below:
const inventorNamedAda = inventors.find(
    name => name.first == 'Ada'
)
...
const isAdultPresent = devs.some(
    adult => (currentYear - (adult.year)) >= 18
)
...
// Complete the exercise in the space below:
const isEveryone19OrOlder = devs.every(
    old => (currentYear - (old.year)) >= 19
)
